...
# ==============================================================================
"""Converts imagenet32 data to TFRecords of TF-Example protos.

This module reads the files
that make up the imagenet32 data and creates two TFRecord datasets: one for train
...
def _add_to_tfrecord(filename, tfrecord_writer, offset=0):
  ...
  Args:
    filename: The filename of the imagenet32 pickle file.
...
def _get_output_filename(dataset_dir, split_name):
  ...
  """
  return '%s/imagenet32_%s.tfrecord' % (dataset_dir, split_name)
